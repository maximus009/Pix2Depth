...
def train(**kwargs):
    ...
    try:
        ...
        for e in range(nb_epoch):
            ...
            if e % 5 == 0:
                gen_weights_path = os.path.join('../../models/%s/pix2depthgen_weights_epoch%s.h5' % (model_name, e))
                generator_model.save_weights(gen_weights_path, overwrite=True)

                disc_weights_path = os.path.join('../../models/%s/pix2depthdisc_weights_epoch%s.h5' % (model_name, e))
                discriminator_model.save_weights(disc_weights_path, overwrite=True)

                DCGAN_weights_path = os.path.join('../../models/%s/pix2depthDCGAN_weights_epoch%s.h5' % (model_name, e))
