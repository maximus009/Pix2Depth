...
model.load_weights('../../models/CNN/pix2depthgen_weights_epoch300.h5') #gen_weights_epoch45.h5
model.save('../../models/p2d_pix2pix.h5')
dmap = model.predict(img)[0]
print dep[0][0][0]
print dep.shape
print dmap[0][0]
cv2.imwrite("test.jpg",np.hstack((dmap*255,dep[0]*255)))
